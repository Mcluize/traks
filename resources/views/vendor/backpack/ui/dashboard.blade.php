        ...
        <div class="incident-stats">
            <div class="incident high-risk">
                ...
                <div class="incident-icon-container">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <!-- Circle background with 44% opacity -->
                        <circle cx="9" cy="9" r="9" fill="#FF0000" fill-opacity="0.44"/>
                        <!-- Original arrow icon, positioned in the center -->
...
<div class="card map-card">
    <div class="card-header">
        ...
        <div class="header-right">
            <input type="text" placeholder="Search Tourist" class="search-input">
        </div>
    </div>
    <div class="card-body">
    ...
    <div class="card logs-card">
        <div class="card-header">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14.0532 6.85956L7.50006 10.7921L0.946936 6.85956C0.804796 6.77428 0.6346 6.74895 0.473787 6.78916C0.312975 6.82936 0.174719 6.9318 0.0894358 7.07394C0.00415207 7.21608 -0.0211739 7.38627 0.0190292 7.54709C0.0592323 7.7079 0.161671 7.84615 0.303811 7.93144L7.17881 12.0564C7.27602 12.1148 7.38728 12.1457 7.50069 12.1457C7.61409 12.1457 7.72535 12.1148 7.82256 12.0564L14.6976 7.93144C14.8397 7.84615 14.9421 7.7079 14.9823 7.54709C15.0225 7.38627 14.9972 7.21608 14.9119 7.07394C14.8267 6.9318 14.6884 6.82936 14.5276 6.78916C14.3668 6.74895 14.1966 6.77428 14.0544 6.85956H14.0532Z" fill="#484A58"/>
                <path d="M14.0533 9.71427L7.50018 13.6462L0.947056 9.71427C0.876676 9.67204 0.798667 9.64409 0.717484 9.63201C0.636301 9.61993 0.553534 9.62395 0.473907 9.64386C0.394281 9.66377 0.319356 9.69916 0.253408 9.74803C0.187461 9.79689 0.131784 9.85826 0.089556 9.92864C0.0473278 9.99902 0.0193755 10.077 0.00729513 10.1582C-0.00478526 10.2394 -0.000757171 10.3222 0.0191494 10.4018C0.0593525 10.5626 0.161791 10.7009 0.303931 10.7861L7.17893 14.9112C7.27614 14.9696 7.3874 15.0004 7.50081 15.0004C7.61421 15.0004 7.72547 14.9696 7.82268 14.9112L14.6977 10.7861C14.8398 10.7009 14.9423 10.5626 14.9825 10.4018C15.0227 10.241 14.9973 10.0708 14.9121 9.92864C14.8268 9.7865 14.6885 9.68406 14.5277 9.64386C14.3669 9.60366 14.1967 9.62898 14.0546 9.71427H14.0533Z" fill="#484A58"/>
                <path d="M0.303049 5.22339L6.54305 8.96776C6.83196 9.14157 7.16276 9.2334 7.49992 9.2334C7.83709 9.2334 8.16788 9.14157 8.4568 8.96776L14.6968 5.22339C14.7892 5.16782 14.8657 5.0893 14.9187 4.99544C14.9718 4.90158 14.9997 4.79559 14.9997 4.68776C14.9997 4.57994 14.9718 4.47394 14.9187 4.38009C14.8657 4.28623 14.7892 4.2077 14.6968 4.15214L8.4568 0.407764C8.16782 0.234157 7.83705 0.142441 7.49992 0.142441C7.1628 0.142441 6.83203 0.234157 6.54305 0.407764L0.303049 4.15214C0.210642 4.2077 0.134181 4.28623 0.0810998 4.38009C0.0280185 4.47394 0.00012207 4.57994 0.00012207 4.68776C0.00012207 4.79559 0.0280185 4.90158 0.0810998 4.99544C0.134181 5.0893 0.210642 5.16782 0.303049 5.22339Z" fill="#484A58"/>
                </g>
                <defs>
            ...
            Tourist <span>Logs</span>
        </div>
        <div class="card-body">
            <div class="log-entries">
                @for ($i = 1; $i <= 7; $i++)
                <div class="log-entry">
                    <div class="log-time">7:00 - 20:{{ str_pad($i * 5, 2, '0', STR_PAD_LEFT) }}</div>
                    <div class="log-description">Arrived in there landmark.</div>
                </div>
                @endfor
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        options: {
            ...
            scales: {
                y: {
                    beginAtZero: true,
                    grid: {
                        color: document.body.classList.contains('dark-mode') ? '#3a3a55' : '#eee'
                    },
                    ticks: {
                        color: document.body.classList.contains('dark-mode') ? '#b0b0b0' : '#666'
                    }
                },
                x: {
                    grid: {
    ...
    // Dark mode integration with Backpack
    ...
    // If Backpack uses localStorage for theme preference
